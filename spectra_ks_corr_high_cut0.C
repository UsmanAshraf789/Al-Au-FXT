{
   ...
   TString oname = "alau"+Ecm+"_ks_spectra_"+cuttag+"_high.txt";
   ...
   TString ofigname = "alau"+Ecm+"_ks_spectra_"+cuttag+"_high.pdf";
   c1->SaveAs(ofigname);
   TString ointyieldname = "alau"+Ecm+"_ks_cent_"+cuttag+"_high.txt";
   ...
   TString ofitparname = "alau"+Ecm+"_ks_fit_"+cuttag+"_high.txt";
