{
   ...
   TString iyieldname = "alau"+Ecm+"_ks_yield_"+cuttag+".txt";
   ...
   Double_t fitparms_cut0[50]={0.000109687,0.1869333,0.00258756,0.176135,0.0154873,0.197197,0.256709,0.191183,2.0514,0.214666,44.2453,0.198797};
   ...
   TString oname = "alau"+Ecm+"_ks_spectra_"+cuttag+"_low.txt";
  ...
  leg->SetTextFont(22);
   ...
   TString ofigname = "alau"+Ecm+"_ks_spectra_"+cuttag+"_low.pdf";
   //TString ofigname = "alau"+Ecm+"_ks_spectra_"+cuttag+"_low.eps";
   c1->SaveAs(ofigname);
   TString ointyieldname = "alau"+Ecm+"_ks_cent_"+cuttag+"_low.txt";
   ...
   TString ofitparname = "alau"+Ecm+"_ks_fit_"+cuttag+"_low.txt";
