{
   ...
   TString lowname = "alau"+Ecm+"_ks_spectra_"+cuttag+"_low.txt";
   TString highname = "alau"+Ecm+"_ks_spectra_"+cuttag+"_high.txt";
   ...
   TString oname = "alau"+Ecm+"_ks_spectra_"+cuttag+".txt";
   ...
   TString lowname = "alau"+Ecm+"_ks_cent_"+cuttag+"_low.txt";
   TString highname = "alau"+Ecm+"_ks_cent_"+cuttag+"_high.txt";
   ...
   TString ofigname = "alau"+Ecm+"_ks_spectra_"+cuttag+".pdf";
   c1->SaveAs(ofigname);
   TString ointyieldname = "alau"+Ecm+"_ks_cent_"+cuttag+".txt";
