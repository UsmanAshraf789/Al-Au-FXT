...
Float_t  centbd[kGroup][kCentBin+1]={{42,49,57,66,75,85,500}};
...
TH2F * hVxy = new TH2F( "Vxy", "Vertex XY of selected events", 1000, -5, 5,1000,-5,5) ;
   TH2F * hrapIm = new TH2F( "ImRap", "Invariant mass Vs Rapidity", 1000, -5, 5,1000,-5,5) ;
   ...
   for(Int_t ind = 0; ind < 2; ind++){
	...
	for (Long64_t jentry=0; jentry<nentries;jentry++) {
	   ...
	   if(ind==0)hVxy->Fill(dst.primvertexX,dst.primvertexY);
	if(fabs(dst.primvertexZ)< 210 && fabs(dst.primvertexZ)> 212)continue;
	   ...
	   for(Int_t i=0;i<dst.nv0;i++){
		...
		if(ind==0)hrapIm->Fill(dst.v0rapidity[i],dst.v0mass[i]);
